...
@section('title', 'Đăng Nhập - Snack Store')
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
            ...
            <div class="bg-white border-b border-slate-100 text-center py-6 px-4">
                <h2 class="text-2xl font-bold text-slate-900 tracking-tight">Đăng Nhập Tài Khoản</h2>
                <p class="text-slate-500 mt-1 text-sm font-medium">Vui lòng nhập thông tin để tiếp tục.</p>
            </div>
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <div class="flex items-center">
                            <input id="remember-me" name="remember" type="checkbox" class="h-4 w-4 text-orange-600 focus:ring-orange-500 border-slate-300 rounded cursor-pointer">
                            <label for="remember-me" class="ml-2 block text-sm font-medium text-slate-700 cursor-pointer">
                                Ghi nhớ đăng nhập
                            </label>
                        </div>
                    </div>
                ...
                <div class="mt-8 text-center text-sm border-t border-slate-100 pt-6">
                    <p class="text-slate-600 font-medium">
                        Chưa có tài khoản? 
                        <a href="{{ route('register') }}" class="font-bold text-orange-600 hover:text-orange-700 transition">Đăng ký ngay</a>
                    </p>
                </div>
            </div>
        </div>
